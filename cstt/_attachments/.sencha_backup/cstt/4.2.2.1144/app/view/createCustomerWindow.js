                ...
                success: function(result, request){
                    ...
                    callback: function() {
	                    ...
	                    var contactWindow = Ext.widget('createContactWindow');
	       				contactWindow.closable = false;
	       				contactWindow.modal = true;
	        			contactWindow.down('#companyCombo').setValue(docID);
	        			contactWindow.down('#companyCombo').setReadOnly(true);
	        			contactWindow.doLayout();
	        			contactWindow.down('#cancel').hide();
	        			contactWindow.show();
