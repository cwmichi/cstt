...
Ext.define('cstt.view.contactPersonGrid', {
    ...
    onEditClick: function(grid, rowIndex, colIndex) {
        selectContact = grid.store.getAt(rowIndex);
    ...
    onGridpanelBeforeRender: function(abstractcomponent, options) {
        ...
        processDisabled: function(disabled, record) {
	    	...
	    	if(disabled === true) {
	    		var msgText = 'M&ouml;chten Sie die Kontaktperson <u><b>' + email + '</b></u> deaktivieren?'
	    	} else {
	    		var msgText = 'M&ouml;chten Sie die Kontaktperson <u><b>' + email + '</b></u> aktivieren?'
	    	}
    	
	    	Ext.MessageBox.show({
	    		title: 'Kontaktperson aktivieren/deaktivieren?',
				msg: msgText,
    	...
    	function confirmProcess( btn ) {
    		...
    		if(btn == 'yes') {
		    	...
		    	Ext.example.msg("Synchronisierung", "Kontaktperson wurde aktiviert/deaktiviert");
